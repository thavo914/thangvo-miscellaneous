# Day 1: Grammar & Sentence Structures (Relocation to Da Nang)

---

## 🔍 1. Grammar Focus (Days 1–3)

### Rule 1: Used to vs. Get used to vs. Be used to
*   **Quote**: 
    - *"It took me a while to get used to the quieter streets..."*
    - *"...because I was used to hearing traffic noise all night..."*
*   **Explanation**:
    - **Used to + Base Verb**: Describes past habits or states that are no longer true. (*"I used to live in Sai Gon."*)
    - **Get used to + Noun / V-ing**: Describes the *process* of adapting or adjusting to something new. (*"I am getting used to the local food."*)
    - **Be used to + Noun / V-ing**: Describes a state of being familiar or comfortable with something; it is no longer strange. (*"I am used to riding in the rain."*)
*   **Common Pitfall Box**:
    > [!WARNING]
    > **Common Mistake**: Confusing the verb forms after *get used to* / *be used to*.
    > - *Incorrect*: I am used to live in a quiet city.
...
*   **Quote**: 
    - *"...I forgot to budget for eating out..."*
    - *"I'll never forget walking to the beach..."*
    - *"I always remember to check the bus schedule..."*
*   **Explanation**:
    - **Forget/Remember + To-Infinitive**: Means to remember or forget an action *before* doing it (forgetting or remembering a duty/task).
        - *Example*: *"Remember to turn off the server."* (Task to be done)
    - **Forget/Remember + Gerund (V-ing)**: Means to recall or forget a past event or memory *after* it happened.
        - *Example*: *"I remember configuring that server last month."* (A past memory)
*   **Common Pitfall Box**:
    > [!WARNING]
...
*   **Explanation**:
    - **Prefer + Noun/V-ing + to + Noun/V-ing**: To express general preferences.
        - *Example*: *"I prefer living in Da Nang to living in Sai Gon."*
    - **Would rather + Base Verb + than + Base Verb**: To express specific preferences in a given situation.
        - *Example*: *"I would rather rent a flat near the beach than stay downtown."*
*   **Common Pitfall Box**:
    > [!WARNING]
    > **Common Mistake**: Using *than* with *prefer*, or *to* with *would rather*.
    > - *Incorrect*: I prefer Da Nang than Sai Gon.
...
### Pattern 1: It took me a while to get used to + [Noun/V-ing] + because + [Reason]
*   **Communicative Function**: To explain the timeline and reason for adapting to a new situation.
*   **Examples**:
...
1. *I am getting used to ride a motorbike in Da Nang traffic.*
2. *I prefer to live near the beach than live in the noisy city center.*
3. *Don't forget sending the relocation documents to HR before this Friday.*

<details>
<summary><b>Answer Key & Explanations</b></summary>

1. **Correction**: *I am getting used to **riding** a motorbike in Da Nang traffic.*
   - *Explanation*: "Get used to" is followed by a gerund (V-ing) or a noun, not an infinitive.
2. **Correction**: *I prefer living near the beach **to** living in the noisy city center.* (Or: *I would rather live near the beach **than** live in the noisy city center.*)
   - *Explanation*: The verb "prefer" takes the preposition "to" to connect choices, whereas "would rather" takes "than".
3. **Correction**: *Don't forget **to send** the relocation documents to HR before this Friday.*
   - *Explanation*: This is a reminder about a future task/duty, so "forget + to-infinitive" must be used. "Forget + V-ing" would refer to a past memory.
</details>
