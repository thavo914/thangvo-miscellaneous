# Day 3: Conversation Translation & Analysis (Topic 1: Seeking Mentor Review Guidance)
...
* **Goal**: Overcome self-doubt and practice answering high-pressure career challenges spontaneously.
* **Instructions**:
  1. Open ChatGPT Voice Mode.
  2. Input this dramatic persona prompt:  
     *"Act as a super-direct, no-nonsense executive career coach who believes I am severely underpricing myself. Challenge me on why I deserve recognition and demand that I prove my impact."*
  3. Respond spontaneously without pausing!
...
* **Goal**: Decode conversational nuance and natural intonation patterns in executive dialogue.
* **Instructions**: Complete 3 short TOEIC listening exercises (Parts 3/4). Dictate word-for-word, check against the script, and log missed audio links.

---

## ✍️ Section 1: Block 2 - Workplace Practice: Vietnamese-to-English Conversation Translation Drill (60 Mins)

### 🇻🇳 The Real-Life Scenario (Vietnamese Dialogue)
*Bối cảnh: Thắng (Data Engineer) đang ngồi uống cà phê với anh Huy (Senior Tech Lead / Mentor thân thiết) vào giờ nghỉ trưa để xin lời khuyên trước buổi đánh giá năng lực (performance review) sắp tới.*
...
### 🎯 Task 1: Active Translation & Transcreation Challenge
...
### 💡 Task 2: Native Model Comparison & Contrastive Analysis

<details>
<summary>👉 Click to Reveal the Native English Model Script & Vietlish Pitfalls</summary>
...
#### ⚠️ Common "Vietlish" Pitfalls to Avoid:
| What Vietnamese Learners Often Say | Why It Sounds Unnatural | What Native Speakers Say |
| :--- | :--- | :--- |
| *I am afraid of sounding self-high.* | "Self-high" is a literal translation of *tự cao*. | *...without sounding arrogant / boastful.* |
| *Don't worry what!* | Literal translation of *Lo gì em!* | *Don't sweat it! / No need to worry!* |
| *In the past year I am continuously optimizing...* | Wrong tense for ongoing review achievements. | *Over the past year, I have consistently optimized...* |
| *I want to ask for raise salary 25%.* | Awkward word order. | *I want to ask for a 25% salary raise.* |
| *My salary is lower than market level.* | Simple, low-band phrasing. | *My current compensation is lagging behind market benchmarks.* |
</details>

---

### 🗣️ Task 3: Spoken Rehearsal
* Read the English model dialogue out loud **3–5 times**.
* Pay attention to natural sentence flow, focusing on vocal confidence.
...
## 🌟 Section 3: Band 6.5-7.0 IELTS Cue Card Model Answer
...
Practice roleplaying the dialogue and monologue with ChatGPT Voice Mode.
...
* [ ] Log newly discovered native phrases into your Anki deck.
* [ ] Note down any persistent pronunciation stumbling blocks.
