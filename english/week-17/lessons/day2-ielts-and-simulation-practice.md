# Day 2: IELTS Speaking & Voice Simulation (Topic 1: Articulating Career Value)
...
* **Goal**: Overcome hesitations and train your vocal momentum without stopping for more than 2 seconds.
* **Instructions**:
  1. Pick a random item on your desk (e.g., your coffee mug, wireless mouse, or mechanical keyboard).
  2. Start a 60-second stopwatch.
  3. Pitch why this object is essential to your productivity, creatively connecting it to your work discipline and daily delivery.
...
* **Goal**: Sharpen listening comprehension in workplace settings.
* **Instructions**:
  1. Select 3 TOEIC Part 3/4 audio recordings centered around office promotions, project completions, or manager feedback.
  2. Dictate word-for-word onto your notes. Check against the transcript.
...
### Part 2: IELTS Cue Card (High-Impact Project)

> **Describe an important project or accomplishment at work that you are proud of.**  
> You should say:  
> - What the project was  
> - What challenges you faced while working on it  
> - What specific role you played in the outcome  
> and explain why this project made your work **stand out**.
...
Use this prompt inside ChatGPT Voice Mode to simulate an authentic performance review practice session:

```text
Act as my engineering manager in our annual performance review. Ask me about my key achievements this year and listen to how I present my impact. After each answer, give me concise feedback on how to make my points sound more confident and executive.
```
...
Use this table during or immediately following your AI voice session to record corrections:
...
Use the simulation prompt above to practice your review answers with ChatGPT Voice Mode.
...
* [ ] Fill out the Feedback Logging Table in Section 3 with at least 3 points from your practice.
* [ ] Review your Anki deck and recite the Cue Card answer once without looking at notes.
